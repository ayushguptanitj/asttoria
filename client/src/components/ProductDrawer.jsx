    ...
    <>
      ...
      >
        ...
        <div className="sticky bottom-0 bg-white border-t border-[#E5E7EB] mt-10 px-6 md:px-8 py-4 flex gap-3">
          ...
          <a
            data-testid="drawer-whatsapp-btn"
            href={`https://wa.me/919447390415?text=${waText}`}
            target="_blank"
            rel="noopener noreferrer"
            aria-label="WhatsApp"
            className="px-4 grid place-items-center border border-[#25D366] text-[#25D366] hover:bg-[#25D366] hover:text-white transition-colors rounded-sm"
          >
